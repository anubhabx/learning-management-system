...
import ChapterModal from "@/components/shared/ChapterModal";
import CustomFormField from "@/components/shared/CustomFormField";
import DroppableComponent from "@/components/shared/DroppableComponent";
import Header from "@/components/shared/Header";
import SectionModal from "@/components/shared/SectionModal";
...
const CourseEditor = () => {
  ...
  const onSubmit = async (data: CourseFormData) => {
    try {
      const upatedSections = await uploadAllVideos(
        sections,
        id,
        getUploadVideoUrl
      );
