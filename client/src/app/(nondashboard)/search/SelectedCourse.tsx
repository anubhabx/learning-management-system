import AccordionSections from "@/components/shared/AccordionSections";
...
const SelectedCourse = ({ course, handleEnrollNow }: SelectedCourseProps) => {
  return (
    <div className="selected-course">
      <div>
        <h3 className="selected-course__title">{course.courseTitle}</h3>
      ...
      <div className="selected-course__content">
        ...
        <div className="selected-course__sections">
          <h4 className="selected-course__section-title">Course Content</h4>
