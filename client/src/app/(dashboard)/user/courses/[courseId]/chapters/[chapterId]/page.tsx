...
const Course = () => {
  ...
  const handleProgress = ({ played }: { played: number }) => {
    if (
      ...
      updateChapterProgress(currentSection._id!, currentChapter._id!, true);
    }
  };
      ...
      <div className="course__container">
        <div className="course__breadcrumb">
          <div className="course__path">
            {course.courseTitle} / {currentSection?.sectionTitle} /{" "}
            <span className="course__current-chapter">
              {currentChapter?.chapterName}
            </span>
          </div>
          <h2 className="course__title">{currentChapter?.chapterName}</h2>
